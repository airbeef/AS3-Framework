package com.efg.framework
{
	...
	public class FrameRateProfiler extends Sprite
	{
		...
		private var profilerObject:BitmapData = new BitmapData(20,20, false, 0x000000); //0xff0000
		...
		private var  frameCounter:FrameCounter = new FrameCounter();
		

		public function FrameRateProfiler() 
		{
			//mini Frame counter text/ upper right hand corner
			/*addChild(frameCounter);
			frameCounter.x = 0;
			frameCounter.y = 0;*/
		}
		
		//Physical visual of what framerate profile is
		public function startProfile(frameRate:int):void
		{
			...
			format.size = 24;
			format.font = "Arial";
			format.color = 0xffffff; //0xffffff
			format.bold = true;
		...
		//gathers framerate and shows optimal occurance
		...
		//Calculate framerate, tosses it and throws complete flag
